...
sub PrintHead()
{
    print "#ifndef CLOSURE_H_\n";
    print "#define CLOSURE_H_\n\n";
    ...
    print "//    \"hdcs::networking::shared_ptr\" as this pointer of class.\n";
    ...
    print "//    c3->Run();\n";
    print "//    \n";
    print "//    class ClassB : public hdcs::networking::enable_shared_from_this<ClassB>\n";
    print "//    {\n";
    print "//        public:\n";
    print "//            int m1(int pre_arg, double post_arg);\n";
    print "//     \n";
    ...
    print "//            }\n";
    print "//    };\n";
    print "//    hdcs::networking::shared_ptr<ClassB> ptr(new ClassB);\n";
