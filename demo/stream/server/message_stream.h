...
public:
    ...
    //
    // There have three callback funtion:
    // 1: on_sending
    ...
    // 3: on_send_failed
    //    if send fail, callback "on_send_failed" will be called. 
    //
...
*/
    ...
    // the following two function, implement pure virtual function of byte_stream
    //
...
protected:
    ...
    // Four hook function on the point of starting the sending.
    //
